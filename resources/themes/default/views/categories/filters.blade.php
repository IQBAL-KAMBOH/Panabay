...
@pushOnce('scripts')
    ...
    >
        ...
        <!-- Filters Container -->
        <template v-else>
            <div class="panel-side journal-scroll flex  gap-10 max-lg:gap-5 md:mt-10 max-h-[200px] w-full grid-cols-[1fr] overflow-y-auto overflow-x-hidden  md:ltr:pr-7 md:rtl:pl-7">
                <!-- Filters Header Container -->
                <div class=" h-[50px] items-center justify-between border-b border-zinc-200 pb-2.5 max-md:hidden max-xl:min-w-[270px] md:max-w-[342px]">
